...
$consumer_key = "fwTuxe6c2kHfxvXMX0FIZbGOsc97pALaXDwXzwX6J1Qa0wN40Y";
$consumer_secret = "GgbJtlm2m3XvNk6ccRozHfiBMhAgRE6dkJniRVuuMoXhzIMykn";

// The callback URL is the script that gets called after the user authenticates with tumblr
// In this example, it would be the included callback.php
$callback_url = "http://localhost/tumblr1/oauth_examples/callback.php";
